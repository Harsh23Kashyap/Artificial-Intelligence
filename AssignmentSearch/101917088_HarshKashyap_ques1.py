#1 Write a code in python for the 8 puzzle problem 
# by taking the following initial and final states
...
def BFS(state,goal):
    ...
    while(len(queue)>0 ):
        ...
        print("Given unsorted QUEUE  --- ",queue)
        print("\nGiven QUEUE  --- ",queue)

    print("Total time = ",counter)
    if(not(check)):
        print("Not Found ")   
